...
files_covered_by_e2e = [".tekton/pull-request.yaml", ".tekton/tasks/e2e-test.yaml", ".tekton/tasks/task-switchboard.yaml", ".tekton/scripts/determine-if-e2e-execution-needed.py", "hack/build-and-push.sh"]
